...
flatpak install flatfree org.acreetionos.cinnamon.Terminal
```
...
| [`org.acreetionos.cinnamon.Terminal`](./org.acreetionos.cinnamon.Terminal) | Cinnamon Terminal — GNOME Terminal fork for the Cinnamon Desktop |
